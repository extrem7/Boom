...
require_once "includes/BoomWoocommerce.php";

class Boom extends BoomWoocommerce
{
    ...
    private function enqueueStyles()
    {
        ...
        add_action('current_screen', function () {
            //add_editor_style(get_template_directory_uri() . '/assets/node_modules/bootstrap/dist/css/bootstrap.min.css');
    ...
    private function enqueueScripts()
    {
        add_action('wp_enqueue_scripts', function () {
            ...
            wp_register_script('fontawesome', get_template_directory_uri() . '/assets/node_modules/@fortawesome/fontawesome-free/js/all.min.js');
            ...
            wp_register_script('mask', get_template_directory_uri() . '/assets/node_modules/jquery.maskedinput/src/jquery.maskedinput.js');
    ...
    public function breadcrumb()
    {
        woocommerce_breadcrumb([
            'delimiter' => '<span class="breadcrumb-separator"><i class="fal fa-arrow-right"></i></span>',
        ]);
    }
    ...
    {
        get_template_part('views/clients');
    }

    public function form()
    {
        get_template_part('views/form');
    }
